...
Variants {
    ...
    PanelWindow {
        ...
        property list<var> relevantWindows: HyprlandDataService.windowList.filter(win => win.monitor == monitor?.id && win.workspace.id >= 0).sort((a, b) => a.workspace.id - b.workspace.id)
        ...
        property bool wallpaperSafetyTriggered: {
            ...
            const sensitiveNetwork = (CF.StringUtils.stringListContainsSubstring(NetworkService.networkName.toLowerCase(), Config.options.workSafety.triggerCondition.networkNameKeywords));
