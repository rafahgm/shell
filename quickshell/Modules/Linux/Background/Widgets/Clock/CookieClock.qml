...
import qs.Modules.Linux.Background.Widgets.Clock.DateIndicator
import qs.Modules.Linux.Background.Widgets.Clock.MinuteMarks
...
Item {
    ...
    readonly property list<string> clockNumbers: DateTimeService.time.split(/[: ]/)
    readonly property int clockHour: parseInt(clockNumbers[0]) % 12
    readonly property int clockMinute: DateTimeService.clock.minutes
    readonly property int clockSecond: DateTimeService.clock.seconds
