...
Singleton {
    ...
    FileView {
        ...
        JsonAdapter {
            ...
            property string panelFamily: "linux" // "linux", "windows"

            property JsonObject policies: JsonObject {
                property int ai: Enums.AiPolicy.Enabled // 0: No | 1: Yes | 2: Local
                property int weeb: Enums.WeebPolicy.Enabled // 0: No | 1: Open | 2: Closet
            }
