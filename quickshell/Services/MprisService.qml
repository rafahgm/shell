...
Singleton {
	...
	function updateTrack() {
		this.activeTrack = {
			...
			title: this.activePlayer?.trackTitle || TranslationService.tr("Unknown Title"),
			artist: this.activePlayer?.trackArtist || TranslationService.tr("Unknown Artist"),
			album: this.activePlayer?.trackAlbum || TranslationService.tr("Unknown Album"),
		};
	...
	function setActivePlayer(player: MprisPlayer) {
		...
		console.info(`[Mpris] Active player ${targetPlayer} << ${activePlayer}`)
