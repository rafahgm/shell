...
Singleton {
    ...
    property string failMessage: TranslationService.tr("That didn't work. Tips:\n- Check your tags and NSFW settings\n- If you don't have a tag in mind, type a page number")
    ...
    property var providers: {
        "system": { "name": TranslationService.tr("System") },
        "yandere": {
            "name": "yande.re",
            "url": "https://yande.re",
            "api": "https://yande.re/post.json",
            "description": TranslationService.tr("All-rounder | Good quality, decent quantity"),
            "mapFunc": (response) => {
        ...
        "konachan": {
            ...
            "description": TranslationService.tr("For desktop wallpapers | Good quality"),
            "mapFunc": (response) => {
                return response.map(item => {
                    return {
                        "id": item.id,
        ...
        "zerochan": {
            ...
            "description": TranslationService.tr("Clean stuff | Excellent quality, no NSFW"),
            "mapFunc": (response) => {
        ...
        "danbooru": {
            ...
            "description": TranslationService.tr("The popular one | Best quantity, but quality can vary wildly"),
            "mapFunc": (response) => {
                return response.map(item => {
                    return {
                        "id": item.id,
        ...
        "gelbooru": {
            ...
            "description": TranslationService.tr("The hentai one | Great quantity, a lot of NSFW, quality varies wildly"),
            "mapFunc": (response) => {
        ...
        "waifu.im": {
            ...
            "description": TranslationService.tr("Waifus only | Excellent quality, limited quantity"),
            "mapFunc": (response) => {
        ...
        "t.alcy.cc": {
            ...
            "url": "https://t.alcy.cc",
            "api": "https://t.alcy.cc/",
            "description": TranslationService.tr("Large images | God tier quality, no NSFW."),
            "fixedTags": [
                {
                    "name": "ycy",
                    "count": "General"
    ...
    function setProvider(provider) {
        ...
        if (providerList.indexOf(provider) !== -1) {
            ...
            root.addSystemMessage(TranslationService.tr("Provider set to ") + providers[provider].name
                + (provider == "zerochan" ? TranslationService.tr(". Notes for Zerochan:\n- You must enter a color\n- Set your zerochan username in `sidebar.booru.zerochan.username` config option. You [might be banned for not doing so](https://www.zerochan.net/api#:~:text=The%20request%20may%20still%20be%20completed%20successfully%20without%20this%20custom%20header%2C%20but%20your%20project%20may%20be%20banned%20for%20being%20anonymous.)!") : ""))
        } else {
            root.addSystemMessage(TranslationService.tr("Invalid API provider. Supported: \n- ") + providerList.join("\n- "))
        }
    }
