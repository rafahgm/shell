...
ApplicationWindow {
    ...
    title: TranslationService.tr("Shell conflicts killer")
        ...
        RowLayout {
            ...
            RippleButton {
                ...
                contentItem: StyledText {
                    text: TranslationService.tr("Always")
                }
                onClicked: {
            ...
            RippleButton {
                colBackground: Appearance.colors.colLayer2
                contentItem: StyledText {
                    text: TranslationService.tr("Yes")
                }
                onClicked: {
                    Quickshell.execDetached(["killall", ...conflictGroup.programs])
                    conflictGroup.visible = false
    ...
    ColumnLayout {
        ...
        Item {
            ...
            StyledText {
                ...
                text: TranslationService.tr("Kill conflicting programs?")
                font {
        ...
        Rectangle {
            ...
            ColumnLayout {
                ...
                ConflictingProgramGroup {
                    ...
                    programs: ["kded6"]
                    description: TranslationService.tr("Conflicts with the shell's system tray implementation")
                ...
                ConflictingProgramGroup {
                    ...
                    Layout.fillHeight: false
                    programs: ["mako", "dunst"]
                    description: TranslationServuce.tr("Conflicts with the shell's notification implementation")
