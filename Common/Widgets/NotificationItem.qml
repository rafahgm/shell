...
Item { // Notification item area
    ...
    SequentialAnimation { // Drag finish animation
        ...
        onFinished: () => {
            NotificationsService.discardNotification(notificationObject.notificationId);
        }
    }
                        ...
                        RowLayout {
                            ...
                            Repeater {
                                ...
                                NotificationActionButton {
                                    ...
                                    urgency: notificationObject.urgency
                                    onClicked: {
                                        NotificationsService.attemptInvokeAction(notificationObject.notificationId, modelData.identifier);
                                    }
                                }
                            }
